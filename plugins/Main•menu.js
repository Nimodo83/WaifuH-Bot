...
let { exp, monedas, level, role } = global.db.data.users[m.sender]
...
await conn.sendMessage(m.chat, { image: { url: img.getRandom() }, caption: menu, contextInfo: { mentionedJid: [m.sender], isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: "120363349852849966@newsletter", newsletterName: "✨️ WaifuHBot", serverMessageId: -1, }, forwardingScore: 999, externalAdReply: { title: wm, body: dev, thumbnailUrl: perfil, sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false,
