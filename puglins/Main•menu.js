...
await conn.sendMessage(m.chat, { image: { url: img }, caption: menu, contextInfo: { mentionedJid: [m.sender], isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: idchannel, newsletterName: namechannel, serverMessageId: -1, }, forwardingScore: 999, externalAdReply: { title: 'WAIFUH-BOT MENU', body: 'Powered ByXi_Crew', thumbnailUrl: perfil, sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false,
