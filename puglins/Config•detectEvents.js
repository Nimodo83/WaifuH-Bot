...
await conn.sendMini(m.chat, packname, dev, txt1, icons, icons, channel, m);
}
...
await conn.sendMini(m.chat, packname, dev, txt2, icons, icons, channel, m);
}
...
await conn.sendMini(m.chat, packname, dev, txt3, icons, icons, channel, m);
}
...
await conn.sendMini(m.chat, packname, dev, txt4, icons, icons, channel, m);
}
...
await conn.sendMini(m.chat, packname, dev, txt5, icons, icons, channel, m);
}
...
await conn.sendMini(m.chat, packname, dev, txt6, icons, icons, channel, m);
  }
...
await conn.sendMini(m.chat, packname, dev, txt7, icons, icons, channel, m);
}}